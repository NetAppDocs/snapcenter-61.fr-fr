...
summary: Vous devez créer des rôles SVM si vous configurez des SVM dans des systèmes ASA r2 pour les utiliser avec SanpCenter et que vous ne souhaitez pas utiliser le rôle vsadmin. 
---
