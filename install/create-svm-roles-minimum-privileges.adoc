...
summary: Vous devez créer des rôles SVM si vous configurez des SVM dans ONTAP pour les utiliser avec SanpCenter et que vous ne souhaitez pas utiliser le rôle vsadmin. 
---
