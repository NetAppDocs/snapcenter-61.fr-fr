...
summary: 'Vous pouvez générer une demande de signature de certificat (CSR) et importer le certificat qui peut être obtenu auprès d"une autorité de certification (CA) à l"aide de la CSR générée.  Le certificat aura une clé privée associée.' 
---
