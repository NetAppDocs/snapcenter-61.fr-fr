...
---
= Configurer les informations d'identification pour le plug-in SnapCenter pour la base de données SAP HANA
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Cliquez sur *Nouveau*.
+
image::../media/install_runas_account.gif[Capture d'écran pour installer le compte RUN AS]
