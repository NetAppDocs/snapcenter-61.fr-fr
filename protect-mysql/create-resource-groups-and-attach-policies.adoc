...
NOTE: Les paires clé-valeur personnalisées sont prises en charge pour les systèmes de plug-in MySQL Linux et ne sont pas prises en charge pour la base de données MySQL enregistrée en tant que plug-in Windows centralisé.
