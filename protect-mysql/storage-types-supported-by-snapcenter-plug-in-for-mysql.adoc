...
summary: 'SnapCenter prend en charge une large gamme de types de stockage sur les machines physiques et les machines virtuelles (VM).  Vous devez vérifier la prise en charge de votre type de stockage avant d"installer SnapCenter Plug-in pour MySQL.' 
---
...
[role="lead"]
SnapCenter prend en charge une large gamme de types de stockage sur les machines physiques et les machines virtuelles (VM).  Vous devez vérifier la prise en charge de votre type de stockage avant d'installer SnapCenter Plug-in pour MySQL.
