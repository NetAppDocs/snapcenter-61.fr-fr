...
summary: Lorsque le plug-in pour Windows est installé dans votre environnement, vous pouvez utiliser SnapCenter pour sauvegarder, restaurer et cloner des systèmes de fichiers Windows.  Vous pouvez également effectuer des tâches prenant en charge ces opérations. 
---
...
[role="lead"]
Lorsque le plug-in pour Windows est installé dans votre environnement, vous pouvez utiliser SnapCenter pour sauvegarder, restaurer et cloner des systèmes de fichiers Windows.  Vous pouvez également effectuer des tâches prenant en charge ces opérations.
